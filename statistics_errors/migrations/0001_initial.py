...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('statistics_errors_usererror', (
            ...
            ('url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('loc', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('os', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
            ('browser', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
    ...
    models = {
        ...
        'statistics_errors.usererror': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'device': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loc': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'locale': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
